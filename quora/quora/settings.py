"""
Django settings for CCPL project.
...
SECRET_KEY = '+y#(p^nx=%vc*96pzn6%=g$gf=j^(okfj_3(3xbi813mv8-jf8'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'quora1',         # Replace with your MySQL database name
...
SESSION_COOKIE_NAME = 'sessionid'  # This is the default cookie name for sessions
